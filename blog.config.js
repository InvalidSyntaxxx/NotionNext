...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome to Wtoy\'s cyberspace!🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wtoy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'stay hungry, stay foolish.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wtoy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blogs, Papers, Notes', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1791081494@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/invalidsyntaxxx', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '桂ICP备2024024328号-1', // 备案号 闽ICP备XXXXXXX
  ...
  BACKGROUND_LIGHT: '#b1ef8f', // use hex value, don't forget '#' e.g #fffefc
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  // 所有支持的分享服务：link(复制链接),wechat(微信),qq,weibo(微博),email(邮件),facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena

  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'article/%year%',
